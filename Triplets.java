...
class CodeChef{
    ...
    public static void main (String[] args) throws java.lang.Exception {
        ...
        while(t-- > 0) {
            ...
            for(int i = 0; i<q; i++){
                long max = b[i];
                Integer temp1 = ciel(a, max, f);
                Integer temp2 = ciel(c, max, s);
                if(temp1 != null && temp2 != null){
                    long temp = (((temp1+1)*max)%mod + pa[temp1])%mod;
                    temp = (temp * (((temp2+1)*max)%mod + pc[temp2])%mod)%mod;
                    ans = (ans+temp)%mod;
                    f = temp1;
                    s = temp2;
                }
    ...
    static Integer ciel(long [] arr, long max, int st){
        int n = arr.length;
