    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0){
            ...
            while (q-- > 1){
                ...
                sbr.append(getOp(l1, r1, l2, r2));
                l1 = l2; r1 = r2;
            }
            System.out.println(sbr.length()/2);
            System.out.println(sbr);
        }
        out.close();
    }
    
    static String getOp(int l1, int r1, int l2, int r2){
        StringBuilder sbr = new StringBuilder();
        if(l1 < l2){
            if(r1 <= l2 && r1 > l1){
                sbr.append("L+".repeat(r1-l1-1));
                sbr.append("R+L+".repeat(l2-r1+1));
                sbr.append("R+".repeat(r2-l2-1));
            } else{
                sbr.append("L+".repeat(l2-l1));
                if(r1 < r2) sbr.append("R+".repeat(r2-r1));
                else if(r1 > r2) sbr.append("R-".repeat(r1-r2));
            }
        } else{
            if(r1 >= l2 && r1 < l1){
                sbr.append("L-".repeat(l1-r1-1));
                sbr.append("R-L-".repeat(r1-l2+1));
                sbr.append("R-".repeat(l2-r2-1));
            } else{
                sbr.append("L-".repeat(l1-l2));
                if(r1 < r2) sbr.append("R+".repeat(r2-r1));
                else if(r1 > r2) sbr.append("R-".repeat(r1-r2));
            }
        }
