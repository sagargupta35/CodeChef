...
class CodeChef3 {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0){
            ...
            System.out.println(getGoodPerm(arr, mask, k));
        }
        out.close();
    }
    
    static int getGoodPerm(int [] arr, int mask, int k){
        if(mask == 0){
            if(isGoodPerm(arr, k)) return 1;
            return 0;
        }
    ...
    static boolean isGoodPerm(int [] arr, int k){
