...
class CodeChef3 {
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        int t = in.nextInt();
        BiFunction<Character, Character, Integer> right = (c1, c2) -> (c2-c1+26)%26;
        BiFunction<Character, Character, Integer> left = (c1, c2) -> (c1-c2+26)%26;
            while (t-- > 0) {
            int n = in.nextInt();
            ...
            for(int i = 0; i<n; i++){
                if(s1.charAt(i) != s2.charAt(i)){
                    int r = right.apply(s1.charAt(i), s2.charAt(i));
                    int l = left.apply(s1.charAt(i), s2.charAt(i));
                    r = res+r;
                    l = res-l;
