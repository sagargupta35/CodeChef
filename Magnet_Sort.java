    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t-- > 0){
            ...
            if(isSorted) System.out.println(0);
                ...
                if(!canSort) System.out.println(-1);
                else{
                    // problematic sub array
                    ...
                    boolean n1 = false, s1 = false;
                    boolean n2 = false, s2 = false;
                    for(int i = 0; i<=st; i++){
                        if(s.charAt(i) == 'N') n1 = true;
                        else s1 = true;
                    }
                    for(int i = n-1; i>= end; i--){
                        if(s.charAt(i) == 'N') n2 = true;
                        else s2 = true;
                    }
                    if((n1&&s2) || (n2&&s1)) System.out.println(1);
